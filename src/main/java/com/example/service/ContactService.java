...
import com.example.domain.EmailRepository;
import com.example.domain.EmailSubscribeRepository;
...
public class ContactService {
    ...
    @Autowired
    ContactService(EmailRepository repository, EmailSubscribeRepository emailSubscribeRepository){
